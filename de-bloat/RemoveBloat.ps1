...
Start-Transcript -Path "C:\ProgramData\Eko365\Debloat\Debloat.log"
...
invoke-webrequest -uri "https://raw.githubusercontent.com/eko365sb/public/main/de-bloat/SetACL.exe" -outfile "C:\Windows\Temp\SetACL.exe"
...
if ($manufacturer -like "*Dell*") {
    ...
    # Removed -like Dell due to a linguistic problem with windows defender updates names in Italian locale "aggiornamento dell'intelligence per la sicurezza per .."   
...
if ($mcafeeinstalled -eq "true") {
    ...
    # Download Source
    $URL = 'https://raw.githubusercontent.com/eko365sb/public/main/de-bloat/mcafeeclean.zip'
