...
foreach ($pack in $packs) {
    ...
    if ($installgroupname) {
        ...
        $installgroup = new-aadgroups -appid $appid -appname $appname -grouptype "Install" -prefix $groupprefix
    }
    ...
    if ($uninstallgroupname) {
        ...
        $uninstallgroup = new-aadgroups -appid $appid -appname $appname -grouptype "Uninstall" -prefix $groupprefix
    }
